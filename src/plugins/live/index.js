...
const matchDict = [
    ...
    {
        match: ["修改直播分区:", "修改直播分区", "切换直播分区", "切换直播分区"],
        startWith: true,
        needReplace: true,
        rules: ['admin'],
        func: changeArea
    ...
    {
        match: ["查看直播间信息:", "查看直播间信息"],
        startWith: true,
        needReplace: true,
        rules: [],
        func: (context) => getRoomInfo(context, true, true)
    },
