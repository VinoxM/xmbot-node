...
export const matchDict=[
    ...
    {match: ['启动api:','启动api'],needPrefix:true,startWith: true,needReplace: true,rules:['admin','private'],func:sysOrder.initApi},
    {match: ['关闭api:','关闭api'],needPrefix:true,startWith: true,needReplace: true,rules:['admin','private'],func:sysOrder.closeApi},
