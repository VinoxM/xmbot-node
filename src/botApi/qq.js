...
import {sendWsMsg} from "../utils/socket";
...
const getChatLogMore = ({type, id, index}) => {
...
export default {
    CQ, chatLog, getChatLog, getChatLogMore, initBot, restartBot, replyMsg, replyPrivate, replyGroup
}
